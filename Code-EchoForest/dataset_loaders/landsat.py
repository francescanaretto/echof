...
"""
Normalize the existing binary landsat dataset split under Data-original/landsat.
...
ds.to_csv('../Data-original/landsat/landsat.csv')
X_train.to_csv('../Data-original/landsat/train_set_landsat.csv')
X_test.to_csv('../Data-original/landsat/test_set_landsat.csv')
Y_train.to_csv('../Data-original/landsat/train_labels_landsat.csv')
Y_test.to_csv('../Data-original/landsat/test_labels_landsat.csv')
...
def main() -> None:
    train_x = DATA_DIR / "train_set_landsat.csv"
    test_x = DATA_DIR / "test_set_landsat.csv"
    train_y = DATA_DIR / "train_labels_landsat.csv"
    test_y = DATA_DIR / "test_labels_landsat.csv"
    ...
    print(f"[OK] Normalized landsat dataset files in: {DATA_DIR.resolve()}")
