...
"""
Normalize the existing binary credit dataset split under Data-original/credit.
"""
...
def main() -> None:
    train_x = DATA_DIR / "train_set_credit.csv"
    test_x = DATA_DIR / "test_set_credit.csv"
    train_y = DATA_DIR / "train_labels_credit.csv"
    test_y = DATA_DIR / "test_labels_credit.csv"
    ...
    print(f"[OK] Normalized credit dataset files in: {DATA_DIR.resolve()}")
