...
"""
Normalize the existing binary spotify-r dataset split under Data-original/spotify-r.
"""
...
def main() -> None:
    train_x = DATA_DIR / "train_set_spotify-r.csv"
    test_x = DATA_DIR / "test_set_spotify-r.csv"
    train_y = DATA_DIR / "train_labels_spotify-r.csv"
    test_y = DATA_DIR / "test_labels_spotify-r.csv"
    ...
    print(f"[OK] Normalized spotify-r dataset files in: {DATA_DIR.resolve()}")
